...
class Actor:
    ...
    def __init__(self, inp_dim, out_dim, act_range, act_bias, lr, tau, seed, env):
    ...
    def network(self):
        ...
        """
        inp = Input(shape=(self.hisStep, self.env_dim))
        #        x = BatchNormalization()(inp)
        #
        x = LSTM(128, activation='relu', kernel_initializer=RandomUniform(minval=-1 / np.sqrt(128), maxval=1 / np.sqrt(128), seed=self.seed))(inp)
        x = GaussianNoise(1)(x)
